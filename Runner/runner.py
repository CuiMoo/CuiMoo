    ...
    if obstacle_list:
        for obstacle_rect in obstacle_list:
            ...
            if obstacle_rect.bottom == 300:
                screen.blit(snail_frame_1,obstacle_rect)
            else:
...
# score_surf = test_font.render('My game',False,(64,64,64))  #(text information,anti_alias,color)
# score_rect = score_surf.get_rect(center=(400,50))

#obstacles
#Snail
snail_frame_1 = pygame.image.load('graphics/snail/snail1.png').convert_alpha() # to get rid of unnessesary bg
...
fly_frame_2 = pygame.image.load('graphics/Fly/Fly1.png').convert_alpha()
